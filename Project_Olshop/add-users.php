...
<body>
	...
	<div class="bg-light border-bottom shadow-sm sticky-top">
   	...
   	<div class="container">
		...
		<h1><a href="https://learncodeweb.com/php/php-crud-in-bootstrap-4-with-search-functionality/">Form Pemesanan OlSHOP Name</a></h1>
		...
		<div class="card">
			...
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Buat Orderan</strong> <a href="index.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Users</a></div>
			...
			<div class="card-body">
				...
				<div class="col-sm-6">
					...
					<h5 class="card-title">Tanda<span class="text-danger">*</span> silahkan isi data lengkap!</h5>
					...
					<form method="post">
						...
						<div class="form-group">
							...
							<input type="text" name="username" id="username" class="form-control" placeholder="Masukkan Nama" required>
						...
						<div class="form-group">
							...
							<input type="email" name="useremail" id="useremail" class="form-control" placeholder="Masukkan Email" required>
						...
						<div class="form-group">
							...
							<input type="tel" pattern=".{14,14}" title="Accept US Number format (888) 888-8888" class="tel form-control" name="userphone" id="userphone" x-autocompletetype="tel" placeholder="Masukkan No Handphone" required>
						...
						<div class="form-group">
							...
							<input type="text" name="qty" id="qty" class="form-control" placeholder="Masukkan Banyak Pesanan" required>

						</div>

						<div class="form-group">

							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-plus-circle"></i> Buat Orderan</button>
